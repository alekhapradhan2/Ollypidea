      ...
      <div className="md-body">
        ...
        {tab==="overview" && editing && (
          <div style={{ maxWidth:900 }}>
            ...
            <div className="form-grid">
              <div className="form-group"><label className="form-label">Poster URL (Portrait 2:3)</label><ImageUploadInput value={editForm.posterUrl||""} onChange={v=>setE("posterUrl",v)} name={movie?.title || editForm.title} type="poster" source="Movie" /></div>
            ...
            <div className="form-group"><label className="form-label">Thumbnail URL (Landscape 16:9)</label><ImageUploadInput value={editForm.thumbnailUrl||""} onChange={v=>setE("thumbnailUrl",v)} name={movie?.title || editForm.title} type="thumbnail" source="Movie" /></div>
            <div className="form-group"><label className="form-label">Banner URL (Hero Background)</label><ImageUploadInput value={editForm.bannerUrl||""} onChange={v=>setE("bannerUrl",v)} name={movie?.title || editForm.title} type="banner" placeholder="Wide landscape image URL…" source="Movie" /></div>
          </div>
        )}
